...
func (cc *Chaincode) Invoke(stub shim.ChaincodeStubInterface) sc.Response {
	...
	if function == "invoke" {
		...
		//return all the history of specified user
...
func (cc *Chaincode) invoke(stub shim.ChaincodeStubInterface, args []string) sc.Response {
	var A, B string    // Entities
	var Aval, Bval int // Asset holdings
...
func (cc *Chaincode) delete(stub shim.ChaincodeStubInterface, args []string) sc.Response {
	if len(args) != 1 {
